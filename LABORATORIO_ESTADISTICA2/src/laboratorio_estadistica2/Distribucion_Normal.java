...
public class Distribucion_Normal extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DecimalFormat df2 = new DecimalFormat("#.##");//df2
        double mean = Double.parseDouble(Media.getText());
        double std = Double.parseDouble(DesviacionEstandar.getText());//almacanar los datos
        double Max = Double.parseDouble(RangoMax.getText());
        double Min = Double.parseDouble(RangoMin.getText());
        
        double z1 = ((Min-mean)/std)* -1;
        double z2 = (Max-mean)/std; //formula
        df2.format(z1);//para darle formato a decimales
        
        
        double str1 = Double.parseDouble(tabla.getValue(String.format("%.2f", z1)+":"));//enviar srtring z1, para que retorne el valor de la tabla, para luego parciarlo a double y guardarlo en str1
